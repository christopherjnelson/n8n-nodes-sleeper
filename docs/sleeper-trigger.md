...
publicly available in stable npm `0.2.0`; both `latest` and `next` resolve to the same immutable
artifact. The currently approved n8n Cloud version has not yet been updated to `0.2.0`. Phase 2,
